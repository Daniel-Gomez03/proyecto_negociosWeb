...
class Roles extends PrivateController
{
    ...
    public function run(): void
    {
        ...
        Renderer::render("maintenance/roles/roles", $this->viewData);
    }
    ...
    {
        $this->partialCode = Context::getContextByKey("roles_partialCode");
    ...
    {
        Context::setContext("roles_partialCode", $this->partialCode, true);
